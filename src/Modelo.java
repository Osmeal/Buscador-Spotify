...
public class Modelo {
	...
	public static RespuestaSpotify buscarCancion(String nombreCancion) {
		try {
			String query = nombreCancion.replace(" ", "%20");
			URL url = new URL("https://api.spotify.com/v1/search?q=" + query + "&type=track&limit=1");
			...
			throw new IllegalArgumentException("Error en la búsqueda de canción", e);
		}
	}
